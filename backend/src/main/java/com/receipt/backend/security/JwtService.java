package com.receipt.backend.security;
...
public class JwtService {
    @Value("${JWT_SECRET}") /*.yml에 정의했고, 값을 불러오려면 ${jwt.secret}*/
    ...
    /*제네릭 사용(username, 시간 등 타입이 다양)하여 단일 클레임 추출
     * - 꺼낼때 (String) 캐스팅 하거나, 그냥 get..사용하는등 다양하므로 */
